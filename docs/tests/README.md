...
| Provider and pricing settings | Settings renders seeded providers/prices and can add, validate, update, and delete provider, model price, and model price tier rows. | `test_settings_manages_model_providers_and_prices` |
